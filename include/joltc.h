...
JPH_CAPI uint32_t JPH_HeightFieldShapeSettings_GetBlockSize(JPH_HeightFieldShapeSettings* settings);
JPH_CAPI void JPH_HeightFieldShapeSettings_SetBlockSize(JPH_HeightFieldShapeSettings* settings, uint32_t mBlockSize);
